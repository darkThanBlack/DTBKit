...
extension DTB {
    ...
    ///
    @objc(DTBContainer)
    public final class Container: BaseView {
...
//        }
    ...
    ///
    public struct ShapeConfig: ShapeDatas {
    ...
    public final class ShapeView: BaseView {
        ...
        private var config: ShapeConfig? = nil
        
        public func update(_ value: ShapeConfig?) {
            self.config = value
