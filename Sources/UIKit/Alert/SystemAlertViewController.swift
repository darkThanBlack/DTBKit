...
extension DTB {
    ...
    /// 仿制系统 `UIAlertController(.alert)` 的居中卡片。
    public final class SystemAlertViewController: BaseAlertViewController {
        
        private let creater: DTB.Alert
        
        public init(creater: DTB.Alert) {
        ...
        private func buildTextSection() {
            let titleText = creater.title
            let messageText = creater.message
        ...
        private func makeButton(_ action: DTB.AlertAction, index: Int) -> DTB.Button {
