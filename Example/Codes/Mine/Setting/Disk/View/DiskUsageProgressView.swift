...
extension DTB {
    ...
    class DiskUsageProgressView: UIView {
        ...
        private lazy var appUsedView: UIView = {
            let view = UIView()
            view.backgroundColor = DTB.DiskUsageDepends.themeColor()
            return view
        }()
        
        private lazy var otherUsedView: UIView = {
            let view = UIView()
            view.backgroundColor = DTB.DiskUsageDepends.progressUsedColor()
            return view
        }()
        
        private lazy var freeView: UIView = {
            let view = UIView()
            view.backgroundColor = DTB.DiskUsageDepends.progressFreeColor()
            return view
        }()
        
        private lazy var legendStack: UIStackView = {
            let stack = UIStackView(arrangedSubviews: [
                createLegendItem(color: DTB.DiskUsageDepends.themeColor(), text: DTB.DiskUsageDepends.appName()),
                createLegendItem(color: DTB.DiskUsageDepends.progressUsedColor(), text: DTB.DiskUsageDepends.phoneUsedText()),
                createLegendItem(color: DTB.DiskUsageDepends.progressFreeColor(), text: DTB.DiskUsageDepends.phoneFreeText())
            ])
            stack.axis = .horizontal
