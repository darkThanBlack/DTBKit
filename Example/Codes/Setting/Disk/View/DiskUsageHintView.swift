...
extension DTB {
    ...
    class DiskUsageHintView: UIView {
        ...
        private lazy var refreshButton: UIButton = {
            ...
            button.backgroundColor = DTB.DiskUsageDepends.themeColor()
            button.setTitle(DTB.DiskUsageDepends.reloadText(), for: .normal)
            button.titleLabel?.font = UIFont.systemFont(ofSize: 15.0, weight: .regular)
            button.setTitleColor(DTB.DiskUsageDepends.buttonTitleColor(), for: .normal)
            button.setTitleColor(DTB.DiskUsageDepends.buttonTitleColor().withAlphaComponent(0.6), for: .highlighted)
        ...
        private lazy var hintLabel: UILabel = {
            ...
            label.textColor = DTB.DiskUsageDepends.textColor()
            label.text = DTB.DiskUsageDepends.usageHintText()
            return label
        }()
        ...
        private lazy var usageLabel: UILabel = {
            ...
            label.textColor = DTB.DiskUsageDepends.textColor()
            label.text = DTB.DiskUsageDepends.loadingText()
            return label
        }()
        ...
        private lazy var percentLabel: UILabel = {
            ...
            label.textColor = DTB.DiskUsageDepends.lightTextColor()
            label.text =  DTB.DiskUsageDepends.usagePercentText("0")
            return label
        }()
        ...
        private lazy var updateLabel: UILabel = {
            ...
            label.font = UIFont.systemFont(ofSize: 13.0, weight: .regular)
            label.textColor = DTB.DiskUsageDepends.lightTextColor()
            label.text = DTB.DiskUsageDepends.unloadText()
            return label
        }()
    }
